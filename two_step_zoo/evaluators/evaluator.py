...
class ImageEvaluator(Evaluator):
    def __init__(self, module, *, train_loader, valid_loader, test_loader, use_dinov2=True):
        super().__init__(
            module, valid_loader=valid_loader, test_loader=test_loader,
            valid_metrics={"l2_reconstruction_error"},
            test_metrics={"l2_reconstruction_error", "fd"},
            metric_kwargs={
                "fd": {
...
class ImageFDEvaluator(Evaluator):
    def __init__(self, module, *, train_loader, valid_loader, test_loader, use_dinov2=True):
        super().__init__(
            module, valid_loader=valid_loader, test_loader=test_loader,
            valid_metrics={"l2_reconstruction_error", "fd"},
            test_metrics={"l2_reconstruction_error", "fd"},
            metric_kwargs={
                "fd": {
                    "train_loader": train_loader,
